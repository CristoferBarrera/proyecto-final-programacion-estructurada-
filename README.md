...
| # | Integrante | 
|:---:|---|
| 1 | Barrera Escalante Cristofer | 
| 2 | Couoh Mis Guillermo Moisés | 
| 3 | García Gamboa Eric Emir | Tester |
...
|:---:|---|:---:|
| 1 | **Propuesta** — Definición del proyecto, objetivos, requerimientos y diseño inicial | [🔗 Ver](URL_FASE_1) |
| 2 | **Avances** — Desarrollo parcial, casos de uso, diagramas y código preliminar | [🔗 Ver](URL_FASE_2) |
| 3 | **Entrega final** — Sistema completo, documentación, mapeo de requerimientos y código documentado | [🔗 Ver](URL_FASE_3) |
